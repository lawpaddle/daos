...
static int data_init(int server, crt_init_options_t *opt)
{
	...
	uint32_t	post_init = 0, post_incr = 0;
	...
	crt_gdata.cg_post_init =
	    (d_getenv_int("CRT_POST_INIT", &post_init) == 0) ? post_init : CRT_HG_POST_INIT;
	crt_gdata.cg_post_incr =
	    (d_getenv_int("CRT_POST_INCR", &post_incr) == 0) ? post_incr : CRT_HG_POST_INCR;
